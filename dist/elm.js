...
var _user$project$Models$Product = F3(
	function (a, b, c) {
...
var _user$project$Models$allProducts = {
	ctor: '::',
	_0: {
		id: _user$project$Models$ProductId(1),
		name: 'Red shirt',
		price: 10.0
	},
	_1: {
		ctor: '::',
		_0: {
			id: _user$project$Models$ProductId(989),
			name: 'Green shorts',
			price: 11.0
		},
		_1: {
...
var _user$project$Models$RemoveFromBag = function (a) {
	return {ctor: 'RemoveFromBag', _0: a};
};
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Enter a new product'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _user$project$Views$bagItemView = function (bagItem) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(bagItem.name),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							_elm_lang$html$Html$input,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$value('Remove'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$Models$RemoveFromBag(bagItem)),
										_1: {ctor: '[]'}
									}
								}
							},
...
var _user$project$Views$bagView = function (bag) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Bag'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{ctor: '[]'},
					A2(_elm_lang$core$List$map, _user$project$Views$bagItemView, bag)),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Views$productView = function (product) {
	return A2(
		_elm_lang$html$Html$tr,
		{ctor: '[]'},
		{
...
var _user$project$Views$productListView = function (products) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{ctor: '[]'},
					A2(_elm_lang$core$List$map, _user$project$Views$productView, products)),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Views$view = function (model) {
	return A2(
		...
		},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Views$bagView(model.bag),
				_1: {
					ctor: '::',
			...
			case 'AddToBag':
				...
				return A2(
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							bag: {ctor: '::', _0: newBagItem, _1: model.bag}
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'RemoveFromBag':
